...
export default function Posts() {
  return (
    <div class="h-screen pt-[150px]">
      <div class="container mx-auto max-w-[500px] p-10 border border-slate-200 shadow-xl rounded-xl ">
        <form>
          <h1 class="font-bold text-xl py-5 border-b border-slate-200 mb-5">
          ...
          <p class="text-sm text-slate-500 mt-2">
            Already in Synoma?{" "}
            <a class="text-blue-500 hover:text-blue-600" href="/signIn">
              Sign In
            </a>
          </p>
